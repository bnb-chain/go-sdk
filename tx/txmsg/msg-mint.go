...
func NewMintMsg(from AccAddress, symbol string, amount int64) MintMsg {
	return MintMsg{
		From:   from,
		Symbol: symbol,
		Amount: amount,
...
func (msg MintMsg) GetSigners() []AccAddress { return []AccAddress{msg.From} }
...
func (msg MintMsg) GetInvolvedAddresses() []AccAddress {
